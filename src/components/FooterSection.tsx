      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 lg:grid-cols-[5fr_7fr] lg:items-center">
          ...
          <div className="flex flex-col justify-center md:items-start items-center text-center md:text-left">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-1 md:gap-3 text-center md:text-left">
                ...
                <div>
                  ...
                  <p className="text-primary-foreground/70 text-sm tabular-nums lg:whitespace-nowrap">
                    <span className="md:block lg:inline">WhatsApp:</span>
                    <span className="md:block lg:inline"> +56 9 6334 3550</span>
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 flex flex-col items-center gap-4 md:self-center">
              <a
                href={WHATSAPP_URL}
                target="_blank"
