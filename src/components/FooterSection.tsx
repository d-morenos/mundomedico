      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 lg:grid-cols-[5fr_7fr] lg:items-center">
          ...
          <div className="flex flex-col justify-center">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-primary-foreground/70 text-sm tabular-nums whitespace-nowrap">
